/* Write a method called toMilesPerHour that has 1 parameter of type double with the
  name kilometersPerHour. This method needs to return the rounded value of the
...
How to use the method round and how it works?
  ...
  The Math.round() is a built-in math method which returns the closest long to the
  argument. The result is rounded to an integer by adding 1/2, taking the floor of
  the result after adding 1/2, and typecasting the result to type long.
...
public class SpeedConverter {
    ...
    public static long toMilesPerHour(double kilometersPerHour){
      ...
      /*  long milesPerHour = Math.round(kilometersPerHour / 1.609);
        return milesPerHour;
      */
        return Math.round(kilometersPerHour / 1.609); // to reduce redundant code
    }
